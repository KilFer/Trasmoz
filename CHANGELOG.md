...
* **First version:**
  * Added dark mode
  * Adapted skin to be compliant with last versions of Medium.
  * Added first version of Bluesky Comments (CSS still broken in this version)
  * Added icon options to tags
  * Added "Reading time" on posts
