  ...
  $(function () {
    ...
    $document.on('click', '[data-action]', function(e) {
      ...
      switch(action) {
        ...
        case 'share-bluesky':
          _openWindow(
            'https://bsky.app/intent/compose?text=' + encodeURIComponent(document.title) + ',%20en%20' + encodeURIComponent(location.href) + '%20',
            600, 600);
          break;
        case 'share-mastodon':
          _openWindow(
            'https://mastodonshare.com/?text=' + encodeURIComponent(document.title) + '&url=' + encodeURIComponent(location.href),
            436, 626);
          break;
        case 'share-twitter':
          _openWindow(
